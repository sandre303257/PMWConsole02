<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeBehind="TimeClockAdmin.aspx.vb" Inherits="PMWConsole02.TimeClockAdmin" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Panel ID="PanelTimePunches" runat="server" Visible="true" Wrap="True">
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="BtnClockIn" runat="server" Text="Clock In" Height="75px" Width="130px" style="margin-top: 0px" Font-Bold="False" Font-Size="Smaller" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BtnClockOut" runat="server" Height="75 px" Text="Clock Out" Width="130px" Font-Bold="False" Font-Size="Smaller" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BtnClockInEarly" runat="server" Height="75px" style="margin-top: 0px" Text="Early Clock In" Width="130px" Font-Bold="False" Font-Size="Smaller" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BtnClockOutLate" runat="server" Height="75px" Text="Late Clock Out" Width="130px" Font-Bold="False" Font-Size="Smaller" />
        <br />
        <br />
        ...
        <dx:ASPxGridView ID="GridTimePunches" runat="server" AutoGenerateColumns="False" DataSourceID="SdsTimePunches" EnableTheming="True" KeyFieldName="ID" Theme="Default">
            ...
            <Columns>
                ...
                <dx:GridViewDataTimeEditColumn Caption="In" FieldName="clock_in_1" UnboundType="Decimal" VisibleIndex="2">
                ...
                <dx:GridViewDataTimeEditColumn Caption="Out" FieldName="clock_out_1" UnboundType="Decimal" VisibleIndex="3">
                    <PropertiesTimeEdit AllowNull="False" EditFormat="DateTime">
                    </PropertiesTimeEdit>
                    <SettingsHeaderFilter>
                        <DateRangePickerSettings DisplayFormatString="t">
                ...
                <dx:GridViewCommandColumn ButtonRenderMode="Button" ButtonType="Button" Caption=" " ShowEditButton="True" ShowUpdateButton="True" VisibleIndex="11" ShowDeleteButton="True">
                ...
                <dx:GridViewDataDateColumn Caption="Date Worked" FieldName="date_worked" VisibleIndex="1">
